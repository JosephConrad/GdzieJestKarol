...
var  subscribeImage = jQuery('#platforms').data('background-image');
...
if (subscribeImage) {  jQuery('#platforms').css({ 'background-image':'url(' + subscribeImage + ')' }); };
...
jQuery(document).ready(function($) {
	...
	$('.next-section .go-to-about').click(function() {
  	...
  	$('.next-section .go-to-platforms').click(function() {
    	$('html,body').animate({scrollTop:$('#platforms').offset().top}, 1000);
  	});
